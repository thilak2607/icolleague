...
def ask_assistant():
    ...
    knowledge_base = {
        ...
        'benefits': 'Company benefits include comprehensive health insurance (MediClaim), dental coverage, EPF, ESIC, gratuity, and paid time off. Annual health checkup provided. Visit HR portal or email hr@techcorp.in for details.',
        'it support': 'For IT support, email it-support@techcorp.in or call ext. 5557. For urgent issues, contact IT helpdesk on 2nd floor. Working hours: 9 AM to 6 PM IST.',
        ...
        'training': 'Professional development opportunities available through our learning portal. Annual training budget of ₹50,000 per employee. Certifications and conferences approved by manager.',
        'meeting rooms': 'Book meeting rooms through Outlook calendar system or facilities portal. Conference rooms available: A1-A4 (4-6 persons), B1-B2 (10-15 persons), C1 (20+ persons). 24-hour advance notice required.',
        'security': 'For security concerns, contact security@techcorp.in or call emergency line at ext. 9111. Biometric attendance mandatory. Visitor passes required at reception. CCTV monitoring active.',
        ...
        'supplies': 'Office supplies ordered through facilities portal or email facilities@techcorp.in. Stationery available from admin desk on 1st floor. Print cards with ₹500 monthly credit.',
